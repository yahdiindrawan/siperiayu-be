<template>
    <div class="pb-16 pt-10">
        ...
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Indeks</h1>
        </div>
        <div class="px-4 sm:px-6 lg:px-0">
        <div class="py-6">
...
import { ref } from 'vue'  
const tabs = [
    { name: 'Indeks Lokalitas', href: '#', current: true },
    { name: 'Indeks BG Terbangun', href: '#', current: false },
    { name: 'Indeks BG Terbangun Prasarana', href: '#', current: false },   
]
